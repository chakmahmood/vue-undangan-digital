...
async function submitWish() {
    ...
    try {
         ...
         * comment
         *
         * Name sekarang berasal dari input
         * yang diketik sendiri oleh tamu.
         */
        const response =
            ...
            <div class="wishes-form-inner">
                ...
                <form v-else @submit.prevent="submitWish">
                    ...
                    <div class="form-group">
                        ...
                        <input id="wish-name" v-model="guestName" type="text" maxlength="100"
                            placeholder="Tuliskan nama Anda..." :disabled="submitting" autocomplete="name" />
